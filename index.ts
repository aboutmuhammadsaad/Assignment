...
// Question 11
console.log("\nQuestion 11");
let names:string[]=["Asad", "Ali", "Aladdin", "Waleed"];
...
// Question 13
console.log("\nQuestion 13");
let transport:string[] =["Motorcycle", "Car", "Aeroplane","Train", "Ship"];
...
// Question 14
console.log("\nQuestion 14");
let guest_list:string[]=["Asad","Ali","Waleed"];
...
// Question 18
console.log("\nQuestion 18");
let ar:string[]=["Spain","Italy","France","Germany","Austrilla","America"];
console.log(ar);
let ar1:string[]=[];
...
// Question 20
console.log("\nQuestion 20");
let arrcountries:string[]=["Italy","France","Germany","UK","United States"];
...
// Question 21
console.log("\nQuestion 21");
function create_object(n:string,s:number,t:string){
    return {
        name: n,
        session: s,
        teacher: t
...
//Question 29
console.log("\nQuestion 29");
let favourite_fruits:string[]=["Apple", "Orange", "Banana" ];
...
//Question 30
console.log("\nQuestion 30");
let username:string[]=["Saad", "Ali","Waleed", "Asad", "Admin"];
...
//Question 32
console.log("\nQuestion 32");
let current_users:string[]=["saad","ali","waleed", "asad", "admin"];
let new_users:string[]=["Waleed","Saad", "Hamza","Moez","Umer"];
...
//Question 34
console.log("\nQuestion 34");
let pizzas:string[]=["Chicken Tikka", "Fagita", "Pepperoni"];
...
//Question 35
console.log("\nQuestion 35");
let pets:string[]=["Cat", "Dog" ,"Parret"];
...
//Question 36
console.log("\nQuestion 36");
function make_shirt(sizes: string, text:string){
...
//Question 37
console.log("\nQuestion 37");
function make_shirts( size:string){
    if  (size == "Large"){
...
function make_album(name:string,title:string ,no_of_tracks?:number){
    let music:music={
        artist_name:name,
        album_title:title,
...
//Question 41
console.log("\nQuestion 41");
let magician:string[]=["Saad","Waleed","Ali", "Asad"];
...
//Question 42
console.log("\nQuestion 42");
 function great_magician(mag:string[]){
...
//Question 44
console.log("\nQuestion 44");
let itemsarr:string[] = ["Dijon mustard", " Tzatziki" ," Fruit jam" ];
...
//Question 45
console.log("\nQuestion 45");
function cars(manufature:string , model:number, argument:string, color:string, optionalfeature:string){
    let car={
